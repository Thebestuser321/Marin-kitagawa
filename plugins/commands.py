...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 𝙼𝚊𝚒𝚗 𝙲𝚑𝚊𝚗𝚗𝚎𝚕', url='https://t.me/the_tgguy')
            ],[
            InlineKeyboardButton('❤️‍🔥 𝙷𝙰𝚗𝚒𝚖𝚎', url='https://t.me/Hanime18Verse'),
            InlineKeyboardButton('🤖 Bots', url='https://t.me/the_tgguy/25')
            ],[
...
# Ask Doubt on telegram @KingVJ01
    ...
    if not files_:
        ...
        try:
            ...
            title = '@MarinXkitagawabot  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
